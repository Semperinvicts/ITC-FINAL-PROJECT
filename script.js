...
readMoreButtons.forEach(button => {
    button.addEventListener('click', function() {
        ...
        const details = {
            'Palawan': "Palawan is a breathtaking island province in the Philippines, often celebrated as one of the world's most beautiful destinations. Located in the western Philippine archipelago, it offers a stunning landscape of crystal-clear turquoise waters, limestone cliffs, and lush tropical forests.",
            'Vigan': "Vigan is famous for its exceptionally well-preserved Spanish colonial architecture, particularly along Calle Crisologo, where cobblestone streets are lined with ancestral houses featuring distinctive Spanish-Filipino architectural styles.",
            'Danao': "Also known as the 'Trumpet-Shaped Lake' due to its distinctive shape, it is a serene natural attraction set within a protected landscape. The lake is situated in Lake Danao Natural Park and is surrounded by lush forest, making it a popular destination for nature lovers, hikers, and those seeking tranquil scenery."
        };
        
        alert(details[destination] || 'More details coming soon!');
    });
});
